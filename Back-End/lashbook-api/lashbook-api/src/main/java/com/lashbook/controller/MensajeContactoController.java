...
import com.lashbook.service.MensajeContactoService;
...
public class MensajeContactoController {
    ...
    public MensajeContactoController(
        MensajeContactoService mensajeContactoService
    ) {
        this.mensajeContactoService =
            mensajeContactoService;
    }
    ...
    public void enviarMensaje(
        ...
        mensajeContactoService.guardar(request);
    }
}